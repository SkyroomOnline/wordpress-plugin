...
class WPListTable
{
    ...
    protected function set_pagination_args($args)
    {
        ...
        if (!headers_sent() && !wp_doing_ajax() && $args['total_pages'] > 0
    ...
    protected function pagination($which)
    {
        ...
        if ($disable_first) {
            ...
            $page_links[]
                = sprintf("<a class='first-page' href='%s'><span class='screen-reader-text'>%s</span><span aria-hidden='true'>%s</span></a>",
        ...
        if ($disable_prev) {
            ...
            $page_links[]
                = sprintf("<a class='prev-page' href='%s'><span class='screen-reader-text'>%s</span><span aria-hidden='true'>%s</span></a>",
        ...
        $page_links[] = $total_pages_before.sprintf(_x('%1$s of %2$s', 'paging'), $html_current_page, $html_total_pages)
            .$total_pages_after;
        ...
        if ($disable_next) {
            ...
            $page_links[]
                = sprintf("<a class='next-page' href='%s'><span class='screen-reader-text'>%s</span><span aria-hidden='true'>%s</span></a>",
        ...
        if ($disable_last) {
            ...
            $page_links[]
                = sprintf("<a class='last-page' href='%s'><span class='screen-reader-text'>%s</span><span aria-hidden='true'>%s</span></a>",
